...
public class otladka {
    ...
    //Сохранение статьи в избранное и удаление -
    @Test
    public void saveFirstArticleToMyList() {
        waitForElementAndClick(By.xpath("//*[contains(@text, 'Search Wikipedia')]"), "Cannot find 'Search Wikipedia'",
                5 );

        waitForElementAndSendKeys(By.xpath("//*[contains(@text, 'Search…')]"), "Java", "Cannot find 'Java'",
                5);
        ...
        waitForElementAndClick(By.xpath("//android.widget.ImageView[@content-desk='More options']"),
    ...
    private void assertElementNotPresent(By by, String error_message) {
        //Вычисляем количество эллементов в поиске, переданых по xpath
